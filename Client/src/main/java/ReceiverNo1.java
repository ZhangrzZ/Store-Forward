...
public class ReceiverNo1 {
    ...
    private static final String RECEIVERNAME="ReceiverNo1";
    ...
    public static void main(String[] args) throws Exception{
        ...
        //实例化连接工厂
        connectionFactory = new ActiveMQConnectionFactory(ReceiverNo1.USERNAME, ReceiverNo1.PASSWORD, ReceiverNo1.BROKEURL);
        ...
        try {
            ...
            while(true){
                ...
                if(textMessage.getText().contains(ReceiverNo1.RECEIVERNAME+",Server,")){
                    fileHead = textMessage.getText().split(",");
                    fileName=fileHead[2].toString();
                    System.out.println("Receiver:"+ReceiverNo1.RECEIVERNAME+",fileName:"+fileName);

                    String path = "D:\\my"+ReceiverNo1.RECEIVERNAME+"File\\" + fileName+".txt";
